...
> Historical draft preserved on 2026-09-15. Its numbers and conclusions describe an earlier run, not the final results. Use [current research summary](paper.md) and [final result provenance](exp1/PROVENANCE.md). The earlier 9.83% FPR and consistent crossover claims are superseded.
